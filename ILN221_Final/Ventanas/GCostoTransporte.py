...
class CostoTransporte(Frame):
    def __init__(self, geom):
        ...
        Label(self, text='Consumo Combustible[Lt]: ').place(x=450, y=100)
        ...
        Label(self, text='Produccion CO2 [kg]: ').place(x=450, y=250)
    ...
    def calcular_datos(self):
        ...
        Label(self, text=str(values[5]) + '             ').place(x=600, y=250)
