...
class TodosLosAlimentos(Frame):
    def __init__(self, geom):
        ...
        Label(self, text='kcal').place(x=165, y=280)
        Label(self, text='Prot.').place(x=205, y=280)
        Label(self, text='Carb.').place(x=245, y=280)
        Label(self, text='Calcio').place(x=285, y=280)
        Label(self, text='Hierro').place(x=325, y=280)
        Label(self, text='Vit. A').place(x=365, y=280)
        Label(self, text='Vit. C').place(x=405, y=280)
