...
class Binomial(Frame):
    def __init__(self, geom):
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Binomial.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Hipergeometrica(Frame):
    def __init__(self, geom):
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Hipergeometrica.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Geometrica(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~Geo(p)')
        self.x0y2.place(x=0, y=40)
        self.x0y3 = ttk.Label(self, text='      ')
        self.x0y3.place(x=0, y=60)
        self.x0y4 = ttk.Label(self, text='Valor de X')
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Geometrica.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class BinomialNegativa(Frame):
    def __init__(self, geom):
        ...
        self.valor_e = 0
        self.valor_v = 0
        self.x0y1 = ttk.Label(self, text='Distribucion Binomial Negativa')
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~BN(r, p)')
        self.x0y2.place(x=0, y=40)
        self.x0y3 = ttk.Label(self, text='      ')
        self.x0y3.place(x=0, y=60)
        self.x0y4 = ttk.Label(self, text='Valor de X')
        self.x0y4.place(x=0, y=80)
        self.x0y5 = ttk.Label(self, text='Valor de r')
        self.x0y5.place(x=0, y=100)
        self.x0y5 = ttk.Label(self, text='Valor de p')
        self.x0y5.place(x=0, y=120)
        self.x0y6 = ttk.Label(self, text='Resultados')
        self.x0y6.place(x=0, y=180)
        self.x0y7 = ttk.Label(self, text='fx(x)= {}'.format(self.valor_fx))
        self.x0y7.place(x=0, y=200)
        ...
        self.x0y12 = ttk.Label(self, text='p: Probabilidad')
        self.x0y12.place(x=0, y=320)
        self.x0y12 = ttk.Label(self, text='r: Exitos')
        self.x0y12.place(x=0, y=340)
        ...
        # Column 2
        direct = r'Imagenes\Formulas\BinomialNegativa.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Poisson(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~Poisson(θt)')
        self.x0y2.place(x=0, y=40)
        self.x0y3 = ttk.Label(self, text='      ')
        self.x0y3.place(x=0, y=60)
        self.x0y4 = ttk.Label(self, text='Valor de X')
        self.x0y4.place(x=0, y=80)
        self.x0y5 = ttk.Label(self, text='Valor de θ')
        self.x0y5.place(x=0, y=100)
        self.x0y52 = ttk.Label(self, text='Valor de t')
        self.x0y52.place(x=0, y=120)
        self.x0y6 = ttk.Label(self, text='Resultados')
        self.x0y6.place(x=0, y=180)
        self.x0y7 = ttk.Label(self, text='fx(x)= {}'.format(self.valor_fx))
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Poisson.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Exponencial(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~exp(θ)')
        self.x0y2.place(x=0, y=40)
        self.x0y4 = ttk.Label(self, text='Valor de X')
        self.x0y4.place(x=0, y=80)
        self.x0y5 = ttk.Label(self, text='Valor de θ')
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Exponencial.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Gamma(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~Gamma(r, θ)')
        self.x0y2.place(x=0, y=40)

        self.x0y3 = ttk.Label(self, text='Valor de X')
        self.x0y3.place(x=0, y=80)
        self.x0y4 = ttk.Label(self, text='Valor de r')
        self.x0y4.place(x=0, y=100)
        self.x0y5 = ttk.Label(self, text='Valor de θ')
        self.x0y5.place(x=0, y=120)
        self.x0y6 = ttk.Label(self, text='Resultados')
        self.x0y6.place(x=0, y=180)
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Gamma.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Uniforme(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~Unif(a,b)')
        self.x0y2.place(x=0, y=40)
        self.x0y3 = ttk.Label(self, text='Valor de X')
        self.x0y3.place(x=0, y=80)
        self.x0y4 = ttk.Label(self, text='Valor de a')
        self.x0y4.place(x=0, y=100)
        self.x0y5 = ttk.Label(self, text='Valor de b')
        self.x0y5.place(x=0, y=120)
        self.x0y6 = ttk.Label(self, text='Resultados')
        self.x0y6.place(x=0, y=180)
        self.x0y7 = ttk.Label(self, text='fx(x)= {}'.format(self.valor_fx))
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Uniforme.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Weibull(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~Weibull(α, λ)')
        self.x0y2.place(x=0, y=40)
        self.x0y3 = ttk.Label(self, text='Valor de X')
        self.x0y3.place(x=0, y=80)
        self.x0y4 = ttk.Label(self, text='Valor de α')
        self.x0y4.place(x=0, y=100)
        self.x0y5 = ttk.Label(self, text='Valor de λ')
        self.x0y5.place(x=0, y=120)
        self.x0y6 = ttk.Label(self, text='Resultados')
        self.x0y6.place(x=0, y=180)
        self.x0y7 = ttk.Label(self, text='fx(x)= {}'.format(self.valor_fx))
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Weibull.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
...
class Normal(Frame):
    def __init__(self, geom):
        ...
        self.x0y1.place(x=0, y=20)
        self.x0y2 = ttk.Label(self, text='X~Normal(μ, θ^2)')
        self.x0y2.place(x=0, y=40)
        self.x0y3 = ttk.Label(self, text='      ')
        self.x0y3.place(x=0, y=60)
        self.x0y4 = ttk.Label(self, text='Valor de X')
        self.x0y4.place(x=0, y=80)
        self.x0y5 = ttk.Label(self, text='Valor de μ')
        self.x0y5.place(x=0, y=100)
        self.x0y52 = ttk.Label(self, text='Valor de θ^2')
        self.x0y52.place(x=0, y=120)
        self.x0y6 = ttk.Label(self, text='Resultados')
        self.x0y6.place(x=0, y=180)
        self.x0y7 = ttk.Label(self, text='fx(x)= {}'.format(self.valor_fx))
        ...
        # Column 2
        direct = r'Imagenes\Formulas\Normal.png'
        self.x2y0 = ttk.Button(self, text='Formulas', command=lambda: funciones.formulas(self, direct))
        self.x2y0.place(x=400, y=300, anchor=CENTER)
